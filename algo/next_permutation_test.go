...
func TestNextPermutation(t *testing.T) {
	t.Run("Normal 3", func(t *testing.T) {
		...
		require.Equal(t, xslice.Of(1, 3, 2), a)
		require.True(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(2, 1, 3), a)
		require.True(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(2, 3, 1), a)
		require.True(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(3, 1, 2), a)
		require.True(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(3, 2, 1), a)
		require.False(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(1, 2, 3), a)
	...
	t.Run("Normal 2", func(t *testing.T) {
		a := xslice.Of(1, 2)
		require.True(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(2, 1), a)
		require.False(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(1, 2), a)
	})
	t.Run("Normal 3 Reversed", func(t *testing.T) {
		a := xslice.Of(1, 2, 3).Reversed()
		require.True(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(1, 3, 2).Reversed(), a)
		require.True(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(2, 1, 3).Reversed(), a)
		require.True(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(2, 3, 1).Reversed(), a)
		require.True(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(3, 1, 2).Reversed(), a)
		require.True(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(3, 2, 1).Reversed(), a)
		require.False(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(1, 2, 3).Reversed(), a)
	...
	t.Run("Normal 2 Reversed", func(t *testing.T) {
		a := xslice.Of(1, 2).Reversed()
		require.True(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(2, 1).Reversed(), a)
		require.False(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of(1, 2).Reversed(), a)
	})
	t.Run("One Element", func(t *testing.T) {
		a := xslice.Of(1)
		require.False(t, algo.NextPermutation(a.Range()))
		require.Equal(t, xslice.Of(1), a)
	})
	...
	t.Run("Empty", func(t *testing.T) {
		a := xslice.Of[int]()
		require.False(t, algo.NextPermutation(a.ReverseRange()))
		require.Equal(t, xslice.Of[int](), a)
	})
